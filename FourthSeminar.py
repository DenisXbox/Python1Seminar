...
# кол-во элементов второго множества. Затем пользователь вводит сами
# элементы множеств.

# n, m = input('Введите количество элементов 1 и 2 списка: ').split()
...
print('За один заход можно собрать' , bush_max, 'ягод')